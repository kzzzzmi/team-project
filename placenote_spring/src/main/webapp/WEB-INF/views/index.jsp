		...
		<body>
			...
			<div class="container">
					...
					<div class="main-category">
						<div class="main-category-left">
							<div class="main-category-btnbox">
								<button class="main-category-btns main-category-first-btn select-category">
									전체</button>
							</div>
							<div class="main-category-btnbox">
				...
				<li class="board-list-item">
					...
					<div class="board-item-img">
						<img src="/images/riga-latvia-september-22-2020-600w-1955335966.png" alt="" />
					</div>
					<pre class="board-item-text">안녕하세요</pre>
					<div class="board-item-comment">
						<input type="text" />
			...
			<div class="modal-container2">
				...
				<div class="board-modal-body">
					<div class="board-modal-img">
						<img src="/images/해외_인기_한국_음식_01.png" class="board-modal-img-preview" />
					</div>
