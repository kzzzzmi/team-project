                ...
                <header class="profile-header">
                    ...
                    <div class="profile-info">
                        ...
                        <div class="profile-info-middle">
                            ...
                            <div class="profile-info-middle-item cursor-pointer">팔로잉
                                <div>
                                    <button>0</button>
                                </div>
                            </div>
                            <div class="profile-info-middle-item cursor-pointer">팔로워
                                <div>
                                    <button>0</button>
                                </div>
                            </div>
                ...
                <div class="main-category">
                    <div class="main-category-left">
                        <div class="main-category-btnbox">
                            <button class="main-category-btns" onclick="location.href = '/feed/feed'">
