						...
						<header class="profile-header">
							...
							<div class="profile-info">
								...
								<div class="profile-info-middle">
									...
									<div class="profile-info-middle-item cursor-pointer"
										onclick="location.href = '/follow/following'">
										팔로잉
										<div>
											<button>0</button>
										</div>
									...
									<div class="profile-info-middle-item cursor-pointer"
										onclick="location.href = '/follow/follow'">
										팔로워
										<div>
											<button>0</button>
										</div>
						...
						<div class="main-category">
							<div class="main-category-left">
								<div class="main-category-btnbox">
									<button type="button" class="main-category-btns"
										onclick="location.href = '/my/${principal.username}'">
